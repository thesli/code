...
["", "script.dart", , N, {
  "": "",
  main: function() {
    var pEl = W.Element_Element$html("<b>hello world</b>", null, null);
    document.querySelector("#box").appendChild(pEl);
    J.set$background$x(document.querySelector("#fuck").style, "red");
  }
},
1],
]);
